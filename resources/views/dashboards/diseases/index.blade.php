...
<div class="section-header">
    ...
    <div class="section-header-button ml-auto">
        <a class="btn btn-primary" href="{{ route('dashboard.diseases.create') }}">
            Penyakit Baru
        </a>
    </div>
</div>
...
@section('javascript')
    ...
    $(function() {
        ...
        tableData = $('#table-data').DataTable({
            ...
            searchDelay: 600,
            ajax: {
                url: '{{ route('dashboard.diseases.index') }}'
            },
            order: [[1, 'asc']],
            columns: [
                { data: 'index_row', orderable: false, searchable: false},
                { data: 'nama_penyakit', name: 'nama_penyakit' },
                { data: 'case_studies_count', name: 'case_studies_count', className: 'text-center', searchable: false },
