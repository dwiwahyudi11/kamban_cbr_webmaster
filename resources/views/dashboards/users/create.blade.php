...
<div class="section-body">
    <div class="row">
        <div class="col-12">
            ...
            {!! Form::open(['method'=>'POST', 'route' => 'dashboard.users.store', 'autocomplete'=>'off', 'class'=> 'needs-validation', 'novalidate'=> '']) !!}
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            {!! Form::password('password', array('id' => 'password', 'placeholder' => 'Password', 'class' => 'form-control pwstrength', 'data-indicator' => 'pwindicator', 'required')) !!}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            {!! Form::password('confirm-password', array('id' => 'confirm-password', 'placeholder' => 'Confirm Password', 'class' => 'form-control', 'required')) !!}
                        </div>
                    </div>
                    ...
                    {{-- <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            {!! Form::select('roles[]', $roles, [], array('id' => 'roles', 'class' => 'form-control custom-select select2', 'multiple', 'required')) !!}
                        </div>
                    </div> --}}
                </div>
